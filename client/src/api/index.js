...
export const loginPost = formData => API.post("/api/v1/teacher/login", formData);
...
// Student Api's
export const getStudentsGet = classId => API.get(`/api/v1/teacher/class/${classId}/student`);
