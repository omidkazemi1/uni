...
export const getExamStudentGet = examId => API.get(`/api/v1/student/exam/${examId}`);
export const getExamTeacherGet = examId => API.get(`/api/v1/teacher/exam/student/${examId}`);
export const getStudentExamLogGet = (examId, studentId) =>
    API.get(`/api/v1/teacher/exam/${examId}/${studentId}`);
...
export const completeExamPost = formData => API.post("api/v1/student/exam", formData);
